...
export default function HeroSection() {
  ...
  return (
    <div className="bg-blue-50 dark:bg-gray-800">
      <div className="flex flex-col px-4 py-6 md:flex-row md:px-24 md:py-12 justify-center items-center">
        <div className="mb-4 md:mr-10">
          <Image
            className="rounded-2xl shadow-lg border-2 border-transparent dark:border-blue-500"
            src={myImage}
            width={700}
            alt="me :)"
          />
